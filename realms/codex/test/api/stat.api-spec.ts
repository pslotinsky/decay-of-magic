describe('StatGate (api)', () => {
  describe('POST /api/v1/stat', () => {
    ...
    describe('appliesTo', () => {
      it.todo('accepts appliesTo with one or more of minion | hero | card');
      it.todo('returns 400 when appliesTo is empty');
      it.todo('returns 400 when appliesTo contains an unknown entity type');
    });
  });
